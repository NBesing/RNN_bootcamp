...
const AddExpense = ( props) => {
  ...
  return(
    <div className="container popup ">
        <div className="row d-flex popup-inner  justify-content-center align-items-center mt-5 ">
          <div className="col-12  col-md-5 shadow-lg  form  ps-5 pe-5 pt-2 pb-5">
            <form className="" >
              ...
              <div class="mb-3">
                ...
                <select class="form-select form-select-sm mb-3" value={values.category} onChange={handleInput}>
              ...
              <div class="mb-2">
                ...
                <input className="form-control form-control-sm" type="text" value={values.description} onChange={handleInput} ></input>
              </div>
              <div class="mb-2">
